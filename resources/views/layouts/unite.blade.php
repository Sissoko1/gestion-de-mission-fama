...
<html lang="en" dir="ltr">
  ...
  <!-- PLUGINS CSS STYLE -->
  <link href="  {{asset('plugins/simplebar/simplebar.css')}}plugins/nprogress/nprogress.css" rel="stylesheet" />
  
  
  
  
  <link href="  {{asset('plugins/simplebar/simplebar.css')}}plugins/DataTables/DataTables-1.10.18/css/jquery.dataTables.min.css" rel="stylesheet" />
    ...
    <div class="wrapper">
        ...
        <aside class="left-sidebar sidebar-dark" id="left-sidebar">
          <div id="sidebar" class="sidebar sidebar-with-footer">
            ...
            <div class="app-brand">
              <a href="/index.html">
                <img src="{{asset('assets/images/fama_logo.png')}}" alt="Lono" width="80%"> </br>
                
              </a>
              <span class="brand-name " style="text-align: center; margin-left:40px">KELEBOLO</span>
            </div>
              ...
              <ul class="nav sidebar-inner" id="sidebar-menu">
                  ...
                  <li  class="has-sub" >
                    <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#ui-elements"
                      ...
                      <span class="nav-text">Mission</span> <b class="caret"></b>
                    </a>
                      ...
                      <div class="sub-menu">
                            ...
                            <li >
                              <a class="sidenav-item-link" href="breadcrumb.html">
                                <span class="nav-text">Vehicule de mission</span>
                  ...
                  <li  class="has-sub" >
                    <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#other-page"
                      ...
                      <span class="nav-text">Unité</span> <b class="caret"></b>
                    </a>
                      ...
                      <div class="sub-menu">
                            ...
                            <li >
                              <a class="sidenav-item-link" href="invoice.html">
                                <span class="nav-text">Chef d'unité</span>
                            ...
                            <li >
                              <a class="sidenav-item-link" href="404.html">
                                <span class="nav-text">Liste des millitaires</span>
                            ...
                            <li >
                              <a class="sidenav-item-link" href="page-comingsoon.html">
                                <span class="nav-text">Liste des vehicules</span>
                            ...
                            <li >
                              <a class="sidenav-item-link" href="page-maintenance.html">
                                <span class="nav-text">Programme des missions</span>
                  ...
                  <ul  class="collapse"  id="forms">
                            <div class="sub-menu">
                              ...
                              <li >
                                <a href="basic-input.html">Chef d'unité</a>
                              </li>
                              
                              <li >
                                <a href="input-group.html">Liste millitaire</a>
                              </li>
                              
                              <li >
                                <a href="checkbox-radio.html">Liste vehicule</a>
                              </li>
                              
                              <li >
                                <a href="form-validation.html">Programme des missions</a>
                              </li>
              ...
              <div class="navbar-right ">
                ...
                <div class="search-form">
                  ...
                  <ul class="dropdown-menu dropdown-menu-search">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="index.html">Chef unité</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="index.html">Chef de mission</a>
                    </li>
                    <li class="nav-item">
