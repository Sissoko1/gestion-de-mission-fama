...
<html lang="en" dir="ltr">
  ...
  <title>Kelebolo - Application de gestion des mission des FAMa</title>
    ...
    <div class="wrapper">
        ...
        <aside class="left-sidebar sidebar-dark" id="left-sidebar">
          <div id="sidebar" class="sidebar sidebar-with-footer">
            <!-- Aplication Brand -->
            <div class="app-brand flex">
              <a href="/index.html">
                <img src="{{asset('assets/images/fama_logo.png')}}" alt="Mono">
                <span class="brand-name">kelebolo</span>
              </a>
            </div>
